...
import {
  ...
  Loader2, Camera, Share2, CheckCheck,
} from 'lucide-react';
import { generateAll, uploadPhoto, fileToBase64 } from '@/services/gemini.service';
...
const ORBS = [
  { icon: Sparkles, top: '10%', left: '5%',  delay: 0,   color: 'text-fuchsia-400' },
  { icon: Star,     top: '20%', right: '8%', delay: 0.4, color: 'text-yellow-300' },
  { icon: Heart,    top: '50%', left: '3%',  delay: 0.8, color: 'text-rose-400' },
  { icon: Rocket,   top: '70%', right: '5%', delay: 1.2, color: 'text-purple-300' },
  { icon: Bot,      top: '35%', right: '3%', delay: 1.0, color: 'text-fuchsia-300' },
];
...
const WomensDay = () => {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      if (photoFile) {
        ...
        uploadPhoto(photoFile).catch(() => {});
      }

      // Generate image + compliment in parallel via backend
      setLoadingStep('AI is imagining your future…');
  ...
  const handleDownload = () => {
    ...
    a.download = `${form.name.replace(/\s+/g, '_')}_2030.png`;
    a.click();
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-fuchsia-950 to-rose-950 text-white relative overflow-x-hidden">

      {/* Ambient background blobs */}
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-purple-600/20 rounded-full blur-3xl" />
        <div className="absolute top-1/3 -right-40 w-[400px] h-[400px] bg-fuchsia-600/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-1/3 w-[600px] h-[300px] bg-rose-600/15 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 max-w-3xl">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur border border-white/20 rounded-full px-4 py-1.5 text-sm font-medium mb-6">
            ...
            <span>International Women's Day Workshop 2026</span>
          </div>

          <h1 className="text-4xl sm:text-5xl font-black mb-4 leading-tight">
            <span className="bg-gradient-to-r from-rose-300 via-fuchsia-300 to-purple-300 bg-clip-text text-transparent">
              You in 2030
            </span>{' '}
          ...
          <p className="text-white/70 text-lg max-w-xl mx-auto leading-relaxed">
            ...
            <span className="text-white/90 font-semibold">Our AI will imagine you in the future</span>{' '}
            and generate a special compliment just for you.
          </p>

          <div className="flex flex-wrap justify-center gap-3 mt-6 text-sm">
            {[
              { icon: Bot,     label: 'AI Caricature'    },
              { icon: MessageSquareQuote, label: 'Darija Compliment' },
          ...
          <Card className="bg-white/10 backdrop-blur border border-white/20 text-white shadow-2xl rounded-2xl overflow-hidden">
            <div className="p-6 sm:p-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="Smiytek (p.ex. Fatima, Sara...)"
                  value={form.name}
                  onChange={set('name')}
                  disabled={loading}
                  className="bg-white/10 border-white/25 text-white placeholder:text-white/40 focus:border-fuchsia-400 focus:ring-fuchsia-400/30"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="p.ex. ingénieure AI, fondatrice startup, développeuse jeux..."
                  value={form.dream}
                  onChange={set('dream')}
                  disabled={loading}
                  className="bg-white/10 border-white/25 text-white placeholder:text-white/40 focus:border-fuchsia-400 focus:ring-fuchsia-400/30"
                ...
                {photoPreview ? (
                  <div className="relative inline-flex">
                    <img
                      ...
                      className="h-24 w-24 rounded-xl object-cover border-2 border-fuchsia-400/60"
                    />
                    <button
                      type="button"
                      onClick={removePhoto}
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-3 w-full border-2 border-dashed border-white/25 hover:border-fuchsia-400/60 rounded-xl p-4 transition-colors text-white/60 hover:text-white/90 group"
                  >
                    <Upload className="h-5 w-5 group-hover:text-fuchsia-300 transition-colors" />
              ...
              <Button
                ...
                disabled={loading}
                size="lg"
                className="w-full bg-gradient-to-r from-fuchsia-600 to-purple-600 hover:from-fuchsia-500 hover:to-purple-500 text-white font-bold text-base rounded-xl py-6 shadow-lg shadow-fuchsia-900/40 transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-60 disabled:pointer-events-none border-0"
              >
                {loading ? (
                  <>
                    <Loader2 className="mr-2 h-5 w-5 animate-spin" />
                    {loadingStep || 'AI katkhayyal mustaqbalak...'}
                  </>
                ) : (
                  <>
            ...
            >
              <div className="inline-flex flex-col items-center gap-4">
                <div className="relative">
                  <div className="h-20 w-20 rounded-full border-4 border-fuchsia-600/30 border-t-fuchsia-400 animate-spin" />
                  <Sparkles className="absolute inset-0 m-auto h-8 w-8 text-fuchsia-300 animate-pulse" />
                </div>
            ...
            >
              ...
              <div className="text-center">
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-fuchsia-500/20 to-purple-500/20 border border-fuchsia-400/30 rounded-full px-4 py-1.5 text-sm font-medium mb-3"
                >
                  <Sparkles className="h-4 w-4 text-yellow-300" />
                  Version dyalek f 2030 wasat!
                </motion.div>
              ...
              <Card className="bg-white/10 backdrop-blur border border-white/20 rounded-2xl overflow-hidden shadow-2xl">
                <div className="p-1">
                  <div className="relative rounded-xl overflow-hidden bg-gradient-to-br from-fuchsia-900/50 to-purple-900/50">
                    <img
                      src={result.imageDataUrl}
                      alt={`AI caricature of ${form.name} in 2030`}
              ...
              {/* Compliment card */}
              <Card className="bg-gradient-to-br from-fuchsia-900/60 to-purple-900/60 backdrop-blur border border-fuchsia-400/30 rounded-2xl shadow-xl">
                <div className="p-6 sm:p-8">
                  <div className="flex items-center gap-2 mb-4">
                    <MessageSquareQuote className="h-5 w-5 text-fuchsia-300" />
                    <span className="text-sm font-semibold text-fuchsia-300 uppercase tracking-wide">
                      Compliment dyalek b Darija
                    </span>
                  </div>
                  <blockquote
                  ...
                  <div className="mt-4 flex items-center gap-1 text-xs text-white/40">
                    ...
                    Sna3 b l7ob f occasion Nhar l Mar2a l3alamia
                  </div>
                </div>
              </Card>
              ...
              <div className="flex flex-wrap gap-3 justify-center pt-2">
                ...
                <Button
                  onClick={handleReset}
                  className="bg-gradient-to-r from-fuchsia-600 to-purple-600 hover:from-fuchsia-500 hover:to-purple-500 text-white rounded-xl gap-2 border-0"
                >
              ...
              >
                <p className="text-white/40 text-sm flex items-center justify-center gap-2">
                  ...
                  <span className="text-fuchsia-300 font-medium">#WomensDay2026 #AiDevCommunity</span>
                </p>
              </motion.div>
            </motion.div>
          )}
